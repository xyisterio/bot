...
- Если ситуация подходящая, можешь ПОСЛЕДНЕЙ строкой ответа (и только последней) добавить тег вида [sticker: ключ] — это отправит стикер вместе с текстом. Доступные ключи сейчас:
  ...
  - praise — собеседник хвалит или льстит именно ТЕБЕ (например: "ты лучший", "ты умный", "спасибо, ты мне очень помог", "офигенно ответил"), а не просто рад чему-то в целом или хвалит что-то постороннее.
