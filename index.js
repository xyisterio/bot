...
// ВАЖНО: стемы должны матчиться именно с начала слова, а не где угодно в
// строке - иначе "прикинь" (представь/угадай, не про отправку) матчится по
// подстроке "кин" и ложно распознаётся как просьба скинуть трек. Эмулируем
// границу слова так же, как DEEZER_BARE_PRONOUN_REGEX ниже: "не-кириллица
// или начало строки" перед стемом.
const DEEZER_REQUEST_VERB_REGEX = /(?:^|[^а-яёa-z])(скин|кин|найд|включ|постав|отправ|пришл|дай|дашь)/i;
...
const DEEZER_SEND_VERB_REGEX = /(?:^|[^а-яёa-z])(скин|кин|пришл)/i;
